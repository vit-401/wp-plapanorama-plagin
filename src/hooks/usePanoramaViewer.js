...
import hallway3 from '../media/hallway-view3.png';
import bedroom1 from '../media/bedroom1.png';
import hallway1 from '../media/hallway-view1.png'
import hallway2 from '../media/hallway-view2.png'
import hallwayBathroom from '../media/hallway-bathroom.png';
import laundry from '../media/laundry.png';
import MBView1 from '../media/MB-view1.png';
import MBView2 from '../media/MB-view2.png';
import MBView3 from '../media/MB-enter-to-bathroom.png';
import MBClosed from '../media/MBClosed.png';
import bathroomMR from '../media/bathroomMR.png';
