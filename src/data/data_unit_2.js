...
export const dataUnit2 = {
  ...
  infospotsData: [
    ...
    {position: [4653.19, -1293.66, -1255.49], pointTo: 0, panoramaIndex: 1, hoverText: 'ENTRY STAIRS TO THE 2ND LEVEL'},
    {position: [4945.09, -18.76, 691.7], pointTo: 6, panoramaIndex: 0,arrowUp:true, floor:'first-floor',  hoverText: 'STAIRS TO THE 2ND LEVEL'},
    {position: [-377.47, -2910.73, -4044.14], pointTo: 0, panoramaIndex: 6,arrowUp:true, floor:'basement',  hoverText: 'STAIRS TO THE BASEMENT'},
