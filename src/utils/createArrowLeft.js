export default function createArrowLeft(size = 24) {
  ...
  // Draw the left-pointing arrow shape based on the SVG path data
  ctx.moveTo(15.41 * scale, 16.59 * scale);
  ctx.lineTo(10.83 * scale, 12 * scale);
  ctx.lineTo(15.41 * scale, 7.41 * scale);
  ctx.lineTo(14 * scale, 6 * scale);
  ctx.lineTo(8 * scale, 12 * scale);
  ctx.lineTo(14 * scale, 18 * scale);
  ctx.lineTo(15.41 * scale, 16.59 * scale);
